...
------------------------------
Current Speed: {self.linear_velocity}
Turn Speed: {self.angular_velocity}
=============================="""
        print(ui)
    ...
    def perform(self):
        ...
        if key == 'i':
            ...
            self.cmd_dictinary["linear_x"] = twist.linear.x
            self.cmd_dictinary["angular_z"] = twist.angular.z
            myCmd = json.dumps(self.cmd_dictinary) + "\n"
            data.write(myCmd.encode("ascii"))
